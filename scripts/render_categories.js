let categories = [
  questions_by_category[0].category,
  questions_by_category[1].category,
  questions_by_category[2].category,
  questions_by_category[3].category,
  questions_by_category[4].category,
  questions_by_category[5].category
];
